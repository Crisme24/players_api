...
class PlayersController extends AbstractController
{
    ...
    public function addPlayer(Request $request): JsonResponse
    {
        ...
        if (empty($name) || empty($price)) {
            return new JsonResponse(['status' => 'Name and Price are required.'], Response::HTTP_OK);
        }
        if (empty($team)) {
        ...
        return new JsonResponse(['status' => 'Player successfully created'], Response::HTTP_CREATED);
    }
    ...
    public function updatePlayer($id, Request $request): JsonResponse
    {
        ...
        return new JsonResponse(['status' => 'Player successfully updated.'], Response::HTTP_OK);
    }
    ...
    public function removePlayer($id): JsonResponse
    {
        ...
        return new JsonResponse(['status' => 'Player successfully removed.'], Response::HTTP_OK);
    }
    ...
    public function teamPositionPlayers($team_id, $position_id, $currency = 'EUR'): JsonResponse
    {
        ...
        if (empty($players)){
            return new JsonResponse(
                ['status' => 'Team or Position does not exist or there are no players.'],
                Response::HTTP_OK);
        }
