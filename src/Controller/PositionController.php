...
class PositionController extends AbstractController
{
    ...
    public function addPosition(Request $request): JsonResponse
    {
        ...
        if (empty($name)){
            return new JsonResponse(['status' => 'Name is a required.'], Response::HTTP_OK);
        }

        $this->positionRepository->savePosition($name);

        return new JsonResponse(['status' => 'Position successfully created'], Response::HTTP_CREATED);
    }
    ...
    public function updatePosition($id, Request $request): JsonResponse
    {
        ...
        return new JsonResponse(['status' => 'Position successfully updated'], Response::HTTP_OK);
    }
    ...
    public function removePosition($id): JsonResponse
    {
        ...
        if (!empty($players)) {
            return new JsonResponse(
                ['status' =>
                    'All players with this position must be deleted or modified before attempting to delete the position.'
                ],
                Response::HTTP_OK);
        }
        ...
        return new JsonResponse(['status' => 'Position successfully removed.'], Response::HTTP_OK);
    }
