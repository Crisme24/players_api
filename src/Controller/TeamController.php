...
class TeamController extends AbstractController
{
    ...
    public function addTeam(Request $request): JsonResponse
    {
        ...
        return new JsonResponse(['status' => 'Team successfully created.'], Response::HTTP_CREATED);
    }
    ...
    public function updateTeam($id, Request $request): JsonResponse
    {
        ...
        return new JsonResponse(['status' => 'Team successfully updated.'], Response::HTTP_OK);
    }
    ...
    public function removeTeam($id): JsonResponse
    {
        ...
        return new JsonResponse(['status' => 'Team successfully removed!'], Response::HTTP_OK);
    }
